                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                        <thead style={{ background: 'var(--bg-primary)' }}>
                            <tr>
                                ...
                                <th style={{ padding: '16px 24px', fontSize: '13px', color: 'var(--text-muted)', borderBottom: '1px solid var(--border)', textAlign: 'center' }}>จำนวนที่ยังไม่ได้รับวัคซีน</th>
                            </tr>
                        </thead>
                        <tbody>
                            {loading ? (
                                ...
                                filteredData.map((item, idx) => (
                                    <tr key={item.hospcode} style={{ background: idx % 2 === 0 ? 'transparent' : 'rgba(0,0,0,0.01)' }}>
                                        ...
                                        <td style={{ padding: '14px 24px', fontSize: '14px', textAlign: 'center', fontWeight: 700, color: '#d97706' }}>{Number(item.total_patients).toLocaleString()}</td>
                                    </tr>
                                ))
                            )}
                        </tbody>
